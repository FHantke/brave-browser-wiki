...
| ----------------| ------- | ------ | ------ |
| **Milestone**   | 1.34.x  | 1.35.x    | 1.36.x |
| **Branch name** | 1.34.x | 1.35.x    | master |
...
| Channel | Time | Days      | Public Build (Sparkle/Omaha)       |
|:-------:|:--------:|:---------------------:|:---------------------:|
| `Beta`| 4am UTC (8pm PST/11pm EST) | Monday, Wednesday, Friday | some |
| `Beta`| 4am UTC (8pm PST/11pm EST) | Tuesday, Thursday | all |
| `Dev`| 8am UTC (12am PST/3am EST)| Tuesday & Thursday | Yes|
| `Nightly`| 12pm UTC (4am PST/7am EST)| Monday - Friday| all |
