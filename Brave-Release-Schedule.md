...
| ----------------| ------- | ------ | ------ |
| **Milestone**   | 1.45.x  | 1.46.x    | 1.47.x |
| **Branch name** | 1.45.x | 1.46.x    | master |
...
| 1.45.x  |    107   | N/A                 | November 16, 2022   | Maintenance Release. Originally scheduled for `November 15, 2022`|
