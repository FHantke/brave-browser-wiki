...
- `_override.grd` files are generated automatically and should not be updated. There are a series of regex replacements done (ex: Chrome => Brave) and this file will get overwritten each time.
