...
- `_override.grd` files are generated automatically and should not be updated. There are a [series of regex replacements done](https://github.com/brave/brave-core/blob/master/script/lib/grd_string_replacements.py) (ex: Chrome => Brave) and this file will get overwritten each time.
